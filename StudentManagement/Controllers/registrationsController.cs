...
namespace StudentManagement.Content
{
    public class registrationsController : Controller
    {
        private Stu_LindaDBEntities db = new Stu_LindaDBEntities();
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,mobileno")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,mobileno")] registration registration)
        {
            if (ModelState.IsValid)
            {
